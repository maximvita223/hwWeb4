...
[
    "name" => "Игорь",
    "date start" => "январь 2011",
    "date end" => "Текущее время",
    "descricption" => "Тут описание как происходила работа Игорем 
    Тут описание как происходила работа Игорем 
    Тут описание как происходила работа Игорем",
    ],
    [
    "name" => "Егерь",
    "date start" => "май 2001",
    "date end" => "февраль 2005",
    "descricption" => "Тут описание как происходила работа Егерь 
    Тут описание как происходила работа Егерь 
    Тут описание как происходила работа Егерь",
    ],
    [
    "name" => "Программа Exist",
    "date start" => "август 2005",
    "date end" => "декабрь 2010",
    "descricption" => "Тут описание как происходила работа Программа Exist 
    Тут описание как происходила работа Программа Exist 
    Тут описание как происходила работа Программа Exist",
    ]
    ]
?>
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <div class="w3-container">
            ...
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $works[$i]['date start']?> - <span
                class="w3-tag w3-teal w3-round"><?php echo $works[$i]['date end']?></span></h6>
            <p><?php echo $works[$i]['descricption']?></p>
              <?php endfor; ?>
            <hr>
          </div>
        </div>
